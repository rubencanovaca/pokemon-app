...
describe('PokemonCard', () => {
  ...
  test('applies correct CSS classes', () => {
    ...
    expect(card).toHaveClass('group', 'relative', 'bg-white', 'rounded-2xl', 'shadow-sm');
  });
  ...
  test('handles Pokemon names with special characters', () => {
    ...
    expect(screen.getByText(/nidoran-f/i)).toBeInTheDocument();
    expect(screen.getByText(/#029/i)).toBeInTheDocument();
  });
});
